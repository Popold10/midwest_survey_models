## Look for a file called "security\_breach.txt" in your computer. How was it created?

Le fichier se créer à l'execution du fichier transformers.py en créant le dossier tmp puis le fichier security\_breach.txt
...
Plus sécurisé que d'utiliser pickle
